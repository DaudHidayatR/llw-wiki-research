...
- [[Wiki/Concepts/principle-dry|DRY — Don't Repeat Yourself]] — `concept` (`concept-principle-dry`)
- [[Wiki/Concepts/principle-kiss|KISS — Keep It Simple, Stupid]] — `concept` (`concept-principle-kiss`)
- [[Wiki/Concepts/principle-solid|SOLID — Applied to Shell & Declarative Infrastructure]] — `concept` (`concept-principle-solid`)
- [[Wiki/Concepts/principle-tda|TDA — Tell, Don't Ask and Command–Query Separation]] — `concept` (`concept-principle-tda`)
- [[Wiki/Concepts/principle-yagni|YAGNI — You Aren't Gonna Need It]] — `concept` (`concept-principle-yagni`)
